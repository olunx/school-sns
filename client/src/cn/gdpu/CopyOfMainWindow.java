...
public class CopyOfMainWindow {
	...
	protected void createContents() {
		...
		shell.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/home_nav.gif"));
		...
		newItemMenuItem.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/configure.gif"));
		...
		newItemMenuItem_7.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/run_exec.gif"));
		...
		newItemMenuItem_1.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/cheatsheet_view.gif"));
		...
		newItemMenuItem_2.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/index_co.gif"));
		...
		newItemToolItem_1.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/editor_pane.gif"));
		...
		newItemToolItem_2.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/configure.gif"));
		newItemToolItem_2.setText("设置");

		final ToolItem newItemToolItem_3 = new ToolItem(toolBar, SWT.PUSH);
		newItemToolItem_3.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/cheatsheet_view.gif"));
...
//				System.out.println("选择：" + e.item.toString().contains(""));
		...
		tabItem.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/internal_browser.gif"));
		...
		newItemToolItem_7.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/add_action.gif"));
		...
		newItemToolItem.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/browser.gif"));
		...
		newItemToolItem_6.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/layered_pane.gif"));
		...
		newItemToolItem_8.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/print_edit.gif"));
		...
		newItemToolItem_9.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/generate.gif"));
		...
		newItemToolItem_10.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/cpyqual_menu.gif"));
		...
		fd_browser.top = new FormAttachment(toolBar_1, 5, SWT.BOTTOM);
		...
		menuItem.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/internal_browser.gif"));
		...
		menuItem_1.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/add_action.gif"));
		menuItem_1.setText("新微博");

		final MenuItem newItemMenuItem_3 = new MenuItem(traymenu, SWT.NONE);
		newItemMenuItem_3.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/editor_pane.gif"));
		...
		newItemMenuItem_4.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/configure.gif"));
		...
		newItemMenuItem_6.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/index_co.gif"));
		...
		newItemMenuItem_5.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/run_exec.gif"));
		newItemMenuItem_5.setText("退出");

		final ToolBar toolBar_2 = new ToolBar(shell, SWT.NONE);
		final FormData fd_toolBar_2 = new FormData();
		fd_toolBar_2.bottom = new FormAttachment(0, 45);
		...
		newItemToolItem_11.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/left.gif"));
		...
		newItemToolItem_12.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/right.gif"));
		...
		newItemToolItem_13.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "ico/refresh.gif"));
		...
		trayItem.setImage(SWTResourceManager.getImage(CopyOfMainWindow.class, "/cn/gdpu/ico/home_nav.gif"));
		//
	}
